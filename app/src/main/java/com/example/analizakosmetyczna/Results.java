...
public class Results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i<ingredient_list.size(); i++) {
            if(ingredient_list.get(i).getRate() == "Polecam") polecam++;
            if(ingredient_list.get(i).getRate() == "Polecam, ale") polecam_ale++;
            if(ingredient_list.get(i).getRate() == "Nie polecam") nie_polecam++;
        }
